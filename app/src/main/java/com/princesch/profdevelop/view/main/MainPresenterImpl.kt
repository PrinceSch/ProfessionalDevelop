...
import com.princesch.profdevelop.model.datasource.DataSourceLocal
import com.princesch.profdevelop.model.datasource.DataSourceRemote
    ...
    override fun getData(word: String, isOnline: Boolean) {
        compositeDisposable.add(
            interactor.getData(word, isOnline)
                .subscribeOn(schedulerProvider.inputOutput())
                .observeOn(schedulerProvider.userInterface())
